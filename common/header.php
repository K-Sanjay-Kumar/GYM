...
<head>
    ...
    <title>Amara jyothi public school</title>
                ...
                <div class="top-expended-wrapper">
                            ...
                            <div class="rbt-header-content">
                                ...
                                <div class="header-info">
                                    <ul class="rbt-information-list">
                                        <li>
                                            <a href="mailto:info@ajps.edu.in"><i class="fab fa-facebook-square"></i>info@ajps.edu.in <span class="d-none d-xxl-block">Followers</span></a>
                                        </li>
                                        <li>
                                            <a href="tel:06363853388"><i class="feather-phone"></i>+91-6363853388</a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="rbt-header-content justify-content-start justify-content-xl-center">
                                <div class="header-info">
                                    <div class="rbt-header-top-news">
                                        <div class="inner">
                                            <div class="content">
                                                <span class="rbt-badge variation-02 bg-color-primary color-white radius-round">Hurry up!</span>
                                                <span class="news-text"><img src="../assets/image/icons/hand-emojji.svg" alt="Hand Emojji Images">Admissions are open</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="header-info">
                        <div class="top-bar-expended d-block d-lg-none">
                            <button class="topbar-expend-button rbt-round-btn"><i class=""></i></button>
                        </div>
                    </div>
                </div>
            </div>
